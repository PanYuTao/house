...
import com.hp.house.dao.impl.BiaoDaoImpl;
...
public class BiaoController extends HttpServlet {
	...
	protected void list(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageInfo<Biao> pageInfo = biaoDao.findByPage(c,3);
	...
	protected void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String hfh = request.getParameter("hfh");
//		String eidStr = request.getParameter("eid");
			
		Integer hid = Integer.parseInt(hidStr);			
//		Integer eid = Integer.parseInt(eidStr);
		String dkdDoub = request.getParameter("biao.dkd");
		String skdDoub = request.getParameter("biao.skd");
//		String mkdDoub = request.getParameter("biao.mkd");
		
		double dkd = Double.parseDouble(dkdDoub);
		double skd = Double.parseDouble(skdDoub);
//		double mkd = Double.parseDouble(mkdDoub);
		String mtime = request.getParameter("mtime");

		Biao biao = new Biao(hid, dkd, skd, mtime, hfh);
