...
function getAll(current,aid,sid,zt) {
    ...
    $.ajax({
    	url:'http://localhost:8080/house2023/HouseController?type=list1',
    	dataType:'json',
    	data:{current:current,aid:aid,sid:sid,zt:zt},//在分页基础上，多了三个条件参数
    	type:'post',
    	success:function(mydata)
    	{
    		if(mydata=="9999")
...
function getFirst()
      {
    	  $(".first").live("click",function(){
    		  getAll(1,aid,sid,zt);//首页在分页的基础上，多了三个条件参数
    	  });
      }
