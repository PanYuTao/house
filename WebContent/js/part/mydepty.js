    			...
    			if(xx.pid!=null)
    				{
			    	    ...
			    	    srt += "<td>" +
			    	    		"<a href='javascript:void(0)' class='myupp'>修改</a>" +
			    	    		"<a href='javascript:void(0)' class='mydel'>删除</a>" +
			    	    		"</td>";
			    	    srt += '</tr>';
...
function mydel() {
	$(".mydel").live("click", function() {
		...
		layer.confirm('你确定要删除吗？', 
		       ...
		       , function() 
		          {
		    	      $.post('http://localhost:8080/house2023/DeptController?type=del&pid='+pid,'',function(data){
	    	    	      if(data==1)
	    	    	    	  {
