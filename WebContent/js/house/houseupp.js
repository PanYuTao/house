...
function init() {
	...
	$.ajax({
		url:'http://localhost:8080/house2023/HouseController?type=toUpdate',
		data:{hid:hid},
		dataType:'json',
		type:'post',
		success:function(mydata)
		{
			...
			$("#pic01").attr('src','/house2023/'+mydata.pic1);
			$("#pic02").attr('src','/house2023/'+mydata.pic2);
			$("#pic03").attr('src','/house2023/'+mydata.pic3);
//			$("#pic01").src("F:\java\work\swork\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\house2023\\"+mydata.pic1);
//			$("#pic02").src("F:\java\work\swork\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\house2023\\"+mydata.pic2);
//			$("#pic03").src("F:\java\work\swork\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\house2023\\"+mydata.pic3);
	...
	//得到下拉框的值 
	$.ajax({
		url:'http://localhost:8080/house2023/SortController?type=list',
		dataType:'json',
		type:'post',
		data:'',
		async : true,
	...
	$.ajax({
		url:'http://localhost:8080/house2023/AreaController?type=list',
		dataType:'json',
		type:'post',
		data:'',
		async : true,
...
function commitItem()
{
	...
	$.ajaxFileUpload({
	    url:'http://localhost:8080/house2023/HouseController?type=update',
