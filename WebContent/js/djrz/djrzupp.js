...
function init() {
	...
	//--------------------------------------------------
	$.ajax({
		url:'http://localhost:8080/house2023/DjController?type=toUpdate',
		dataType:'json',
		type:'post',
		data:{mid:mid},
		async : true,
		success:function(mydata)
		{
			   ...
			   eid=mydata.eid;
				...
				//得到下拉框的值 ---------------------------------
				$.ajax({
					url:'http://localhost:8080/house2023/CusController?type=listAll',
					dataType:'json',
					type:'post',
					data:'',
					async : true,
		...
		if(aid!=0)
			{
					...
					$.ajax({
					url:'http://localhost:8080/house2023/HouseController?type=listArea',
					dataType:'json',
					type:'post',
					data:{aid:aid},
					async : true,
...
function commitItem()
{
	...
	if(hid==0)
		...
		$.ajaxFileUpload({
	    url: 'http://localhost:8080/house2023/DjController?type=update',
