...
function init() {
	...
	//--------------------------------------------------
	$.ajax({
		url:'http://localhost:8080/house2023/DjrzController?type=toUpdate',
		dataType:'json',
		type:'post',
		data:{mid:mid},
		async : true,
		success:function(mydata)
		{
			   ...
			   aid=mydata.aid;   
				...
				//得到下拉框的值 ---------------------------------
				$.ajax({
					url:'http://localhost:8080/house2023/CustomController?type=listAll',
					dataType:'json',
					type:'post',
					data:'',
					async : true,
	         ...
	         //-----------------------------------------
					   ...
					   /********************************片区*****************************/
						$.ajax({
							url:'http://localhost:8080/house2023/AreaController?type=listAll',
							dataType:'json',
							type:'post',
							data:'',
							async : true,
						...
						/********************************房子信息***************************/
							$.ajax({
								url:'http://localhost:8080/house_2023/HouseController?type=listAll',
								dataType:'json',
								type:'post',
		...
		if(aid!=0)
			{
					...
					$.ajax({
					url:'http://localhost:8080/house2023/HouseController?type=houseByAid',
					dataType:'json',
					type:'post',
					data:{aid:aid},
					async : true,
...
function commitItem()
{
	...
	if(hid==0)
		...
		$.ajaxFileUpload({
	    url:'http://localhost:8080/house2023/DjrzController?type=update',
